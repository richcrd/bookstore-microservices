...
public class AddStockCommand(IStockItemRepository stockItemRepository, IUnitOfWork unitOfWork)
{
    public async Task<StockItemDto> ExecuteAsync(Guid bookId, StockOperationRequest request,
